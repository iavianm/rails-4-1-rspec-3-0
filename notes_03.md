...
>- Метод создания модели при правильных атрибутах должен выполняться.
...
- Описание каждого запроса начинается с глагола (должен - не должен), для лучшего понимания происходящего.
* * *
## **Создание model spec**
